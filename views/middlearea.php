<header class="main-header">
  <!-- Logo -->
  <a href="<?php echo URL; ?>" class="logo"style="background-image: url(public/50.jpg);">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><img style="width: 50px" src="<?php echo URL; ?>public/logo1.png"  /></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><img src="<?php echo URL; ?>public/logo1.png" style="width: 45px" /></span>
  </a>
  <!-- Header Navbar: style can be found in header.less -->
  <nav class="navbar navbar-static-top"  style="background-image: url(public/50.jpg);">
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header" style="background-image: url(login/css/43.gif);">
